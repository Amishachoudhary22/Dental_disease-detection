...
def predict(model, img):
    ...
    segmentation_result = CLIENT.infer(img, model_id="your-infection-segmentation-model")  # Replace model_id!
    ...
    mouth_segmentation_result = CLIENT2.infer(img, model_id="your-mouth-segmentation-model")  # Replace model_id!
